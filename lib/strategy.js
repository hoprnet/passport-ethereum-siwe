...
Strategy.prototype.authenticate = function(req, options) {
  ...
  try {
    ...
    console.log('Malformed message.' , ex);
  ...
  //   console.log('origin !== siweMessage.uri' , origin, siweMessage.uri);
  ...
  if (siweMessage.notBefore) {
    console.log('siweMessage.notBefore' , siweMessage.notBefore);
  ...
  this._store.verify(req, siweMessage.nonce, function(err, ok, info) {
    console.log('this._store.verify(req, siweMessage.nonce, function(err, ok, info) {' , err, ok, info);
    if (!ok) {
    ...
    siweMessage.validate(signature)
      ...
      .catch(function(err) {
        console.log('.catch(function(err) {' , err);
